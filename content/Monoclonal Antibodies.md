...
- Fuse lymphocytes with a tumour cell this produces hybridoma cells which can produce antibodies and divide by [[Cell Division#Mitosis|Mitosis]].
- Then select a single hybridoma cell and allow it to clone via [[Cell Division#Mitosis|Mitosis]] the cells formed are monoclonal antibodies.
