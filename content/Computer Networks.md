...
---
# TCP/IP Model
TCP is in charge of checking information is delivered reliably.
IP is in charge of routing, using the IP addressing mechanism to send information to the correct location.
1. **Application Layer**
