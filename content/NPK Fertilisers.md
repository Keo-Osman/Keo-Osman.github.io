...
NPK fertilizers are produced in large industrial facilities.
NPK fertilisers are formulations of different salts which contain the required elements needed by plants.
# Nitrogen
The main compound of nitrogen in NPK fertilisers is ammonium nitrate $NH_4NO_3$. To make this you use ammonia made by the [[Haber Process]] which can be used to produce *nitric acid* which is then reacted with more ammonia to make ammonium nitrate. 
# Potassium
