...
Cardioids fall into 2 categories "egg" shaped and those with a "dimple", egg shaped are [[Derivatives#Convex|Convex]] curves, dimples are [[Derivatives#Concave|Concave]] at $\theta = \pi$. They are egg shaped when $p \geq 2q$ and dimple shaped if $q \leq p < 2q$ - This is proved by considering the number of tangents that are perpendicular to the initial line.
