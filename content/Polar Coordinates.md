# Definition
The coordinates of $P$ can be written as $(r,\theta)$ in polar form where $r$ is the distance from the origin and $\theta$ is the angle of rotation counter-clockwise from the positive $x$-axis.
