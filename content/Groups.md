...
A Group has to satisfy the following 4 axioms. Other fundamental corollaries denoted by $(x.y)$
...
- $(3)$ Inverse: $\forall a \in G$, $\exists a^{-1}$ s.t $a*a^{-1} = e$. 
	- $(3.1)$ Works both ways $a^{-1}*a=e$ *(Directly implied by axioms 1-4)*
	- $(3.2)$ Inverses are unique.
	- $(3.3)$ $(a^{-1})^{-1}=a$
- $(4)$ Identity: $\exists$ $e$ s.t $a*e=a$. 
	- $(4.1)$ Works both ways $e*a=a$ *(Directly implied by axioms 1-4)*
	- $(4.2)$ Identity is unique.
