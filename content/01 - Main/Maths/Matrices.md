...
1. Then $A^k = (PDP^{-1})^k = PD^kP^{-1}$ <!--SR:!2024-09-19,3,258-->
...
1. For each $\lambda$, solve $Ax = \lambda x$ to find the corresponding Eigen vector x <!--SR:!2024-09-19,4,298-->
...
1. For each Eigen value, solve $Ax = \lambda x$ to find the corresponding Eigen vector <!--SR:!2024-09-19,4,298-->
