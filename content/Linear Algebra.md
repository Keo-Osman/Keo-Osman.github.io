...
1. Additive associativity: $|u\rangle+(|v\rangle+|w\rangle)=(|u\rangle+|v\rangle)+|w\rangle$
2. Multiplicative associativity: $a\left(b|v\rangle\right)=(ab)|v\rangle$ 
3. Additive commutativity: $|v\rangle+|w\rangle=|w\rangle+|v\rangle$
4. Existence of $|0\rangle:|v\rangle+|0\rangle=|v\rangle,|v\rangle+(-1)|v\rangle=|0\rangle$
5. Multiplicative identity: $1|v\rangle=|v\rangle$ for all elements in $V$ 
6. Scalar distributivity: $a\left(|v\rangle+|w\rangle\right)=a|v\rangle+a|w\rangle$
7. Vector distributivity: $(a+b)|v\rangle=a|v\rangle+b|v\rangle$
