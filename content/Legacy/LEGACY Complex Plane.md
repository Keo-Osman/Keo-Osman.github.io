# Definitions
[[LEGACY Complex Numbers]] can be represented on a cartesian plane *(called the complex plane or an argand diagram)* as a point $(x, y)$ or vector $\begin{pmatrix} x \\ y \end{pmatrix}$ where $z=x+iy$. Therefore the $x$-axis is the real axis and the $y$-axis is the imaginary axis.
...
#z_Legacy/Maths/A-Levels/Further-Core/Complex-Plane
...
---
## A-Level Further Pure 2
#z_Legacy/Maths/A-Levels/Further-Pure/Complex-Plane
