...
**To Solve**
- $z$ has the form $r(\cos \theta + i \sin \theta))$ so by De Moivre's Theorem $z^n = r^n(\cos (n\theta + 2k\pi) + i \sin (n\theta+2k\pi))$
...
#z_Legacy/Maths/A-Levels/Further-Core/Complex-Numbers
