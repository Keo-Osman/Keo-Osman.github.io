...
Biogas generators can be used to produce methane.
- Require a constant $30\degree$C to keep respiration.
- Cant be stored as liquid so needs to be used immediately.
